...
export const initiatePaymentService = async (
  ...
  try {
    ...
    const initiationPayload: ISSLCommerceInitiation = {
      ...
      success_url: `${envVars.APP_URL}/api/v1/payment/success`,
      fail_url: `${envVars.APP_URL}/api/v1/payment/fail`,
      cancel_url: `${envVars.APP_URL}/api/v1/payment/cancel`,
      ipn_url: `${envVars.APP_URL}/api/v1/payment/ipn`,
